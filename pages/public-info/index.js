...
export default function PublicInfo() {
  return (
    <Md>{`
1. [Статут закладу освіти](https://drive.google.com/open?id=1xl8bUSU9XcB6i3aWb66PB9GdtE1dze9I)
1. Ліцензії на впровадження освітньої діяльності
   - [ліцензія](/public-info/license.jpg)
   - [свідотство про атестацію закладу](/public-info/attestation.jpg)
1. [Структура та органи управління закладу освіти](/public-info/structure-and-organization)
1. Кадровий склад
...
1. [Територія обслуговування](/public-info/territory-of-service)   
1. [Ліцензований обсяг та фактична кількість осіб, які навчаються у закладі освіти](/public-info/license)
...
1. [Штатний розпис](https://drive.google.com/file/d/1b_DOIUY_xRqDNPm6gK3JaajGYTs22Ft4/view?usp=sharing)
...
1. [Правила поведінки здобувача освіти в закладі](/public-info/rules-of-conduct.pdf)
1. [Запобігання та протидія булінгу](/public-info/prevent-bullying.pdf)
   - [Про створення постійно діючої комісії з превентивних питань та раннього виявлення неповнолітніх, схильних до вживання психоактивних речовин, алкоголю та тютюнових виробів  і розподіл функціональних обов’язків між членами комісії](/public-info/standing-committee.pdf)
1. [Порядок надання та розгляду заяв про випадки булінгу в закладі освіти](/public-info/statement-bullying.pdf)
1. [Порядок реагування на доведені випадки булінгу](/public-info/order-of-response-bullying.pdf)
...
1. [Рішення колегії відділу освіти від 28.11.2019 - "Про проведення у відповідність до чинного законодавства України мережі закладів загальної середньої освіти Тернівського району м. Кривого Рогу на 2020-2023 роки"](/public-info/ternvo/28.11.2019.zip)
1. [Наказ відділу освіти від 29.11.2019 №319](/public-info/ternvo/29.11.2019_319.zip)
`}</Md>
  );
}
